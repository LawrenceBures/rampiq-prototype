...
# Total fleet across all 3 depots (~130 units)
EQUIPMENT_FLEET = {
...
RISK_WEIGHTS = {
    ...
    "cargo":    0.10,
    "equip":    0.15,
    "upstream": 0.12,   # reduced: limits broad terminal spread, keeps gate-local signal
}
RISK_PENALTIES = {
    "cert_gap_t30":   1.15,
    "cert_gap_t15":   1.30,
    "weather":        1.06,   # was 1.10 — convective threat real but not universal penalty
    "adjacency":      1.08,
}
RISK_THRESHOLDS = {"watch": 52, "critical": 76}   # raised: focus on genuinely stressed flights
...
DELAY_BASE_RISK = {
    "crew":      0.03,   # was 0.04
    "equipment": 0.02,   # was 0.03
    "bag":       0.03,   # was 0.04
    "upstream":  0.04,   # was 0.05
    "env":       0.02,   # was 0.03 — baseline clear-day floor
}
