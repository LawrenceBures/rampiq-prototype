...
import type { UserLite, UserCertification, UserEquipmentQual } from '@/lib/soi-types';
...
function TeamBuilderPage() {
  ...
  if (memberIds.length === 0) {
    return (
      <>
        <Link href="/prototype/soi/operations/workforce-pool" className="rq-back">&larr; Workforce Pool</Link>
  ...
  return (
    <div className="rq-ops-board">
      ...
      <div style={{ padding: '16px', display: 'flex', gap: 8 }}>
        <Link href="/prototype/soi/operations/workforce-pool"
          className="rq-btn-secondary"
          style={{ flex: 1, textDecoration: 'none', textAlign: 'center' }}>
          Modify Team
        </Link>
        <Link href={`/prototype/soi/operations/dispatch?team=${memberIds.join(',')}`}
