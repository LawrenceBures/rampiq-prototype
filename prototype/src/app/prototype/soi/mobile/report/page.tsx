...
import { detectPlatform } from '@/lib/soi-types';
import type { QrTarget, EventType, Severity, AgentIdentity } from '@/lib/soi-types';
...
function ReportForm() {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
            <button
              ...
              onClick={() => router.push('/prototype/soi/mobile/scan')}
              style={{ flex: 1 }}
            >
              Scan Another
            </button>
            <button
              ...
              onClick={() => router.push('/prototype/soi/mobile')}
              style={{ flex: 1 }}
            >
              Done
            </button>
  ...
  if (!target) {
    return (
      <>
        <Link href="/prototype/soi/mobile/scan" className="rq-back">&larr; Back to Scan</Link>
        <div style={{
