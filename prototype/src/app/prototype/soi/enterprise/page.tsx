...
import { ElapsedTime } from '@/components/soi';
      ...
      {section === 'replay' && (
        <div>
          ...
          <div style={{ ...mono, fontSize: 10, color: 'var(--rq-ink-3)', padding: '8px 0' }}>
            Replay investigation is available on the <a href="/prototype/soi/dashboard" style={{ color: 'var(--rq-blue)' }}>Operations Console</a>.
