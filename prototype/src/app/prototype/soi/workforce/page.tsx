...
import { durationLabel, ROLE_LABELS } from '@/lib/soi-types';
import type { ShiftWindow } from '@/lib/soi-types';
    ...
    <div className="rq-ops-board">
      ...
      {!readiness ? (
        ...
        <>
            ...
            <>
              ...
              {readiness.teams.map(tr => (
                <div className="rq-team-card" key={tr.team.id}>
                  ...
                  {/* Members */}
                  {tr.members.map(m => (
                    <Link href={`/prototype/soi/workforce/agent/${m.id}`}
          ...
          {users.map(u => (
            <Link href={`/prototype/soi/workforce/agent/${u.id}`}
