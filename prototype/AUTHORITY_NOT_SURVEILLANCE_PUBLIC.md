# SOI — Operational Coordination Doctrine

## For design partners, pilot conversations, and operational leadership

---

SOI is operational coordination software for airline ramp operations.
...
This document describes what SOI is, what it is not, and how it
...
- **Does not produce HR data.** SOI is not connected to payroll,
...
SOI records every operational action as an immutable event.
...
SOI succeeds when operators say:
> "This system helps me coordinate."

SOI fails when operators say:
...
*SOI is built for the people on the ramp, not for the people
watching the ramp.*
